...
async function saveDetailedStats() {
    ...
    try {
        ...
        const scoreData = {
            ...
            start_time: gameStats.startTime,
            end_time: gameStats.endTime,
            max_lives: gameStats.maxLives,
            max_multiplier: gameStats.maxMultiplier,
            red_balls_collected: gameStats.redBallsCollected,
            blue_balls_collected: gameStats.blueBallsCollected,
            yellow_balls_collected: gameStats.yellowBallsCollected,
            green_balls_collected: gameStats.greenBallsCollected,
            balls_burst: gameStats.ballsBurst,
            balls_clicked: gameStats.ballsClicked,
            tone1_correct: gameStats.tone1Correct,
            tone2_correct: gameStats.tone2Correct,
            tone3_correct: gameStats.tone3Correct,
            tone4_correct: gameStats.tone4Correct,
            tone5_correct: gameStats.tone5Correct,
            tone6_correct: gameStats.tone6Correct,
            repeated_correct: gameStats.repeatedCorrect
        };
